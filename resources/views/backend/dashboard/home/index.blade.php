<div class="wrapper wrapper-content">
    <div class="row">
        <div class="col-lg-3">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <span class="label label-success pull-right">tháng 10</span>
                    <h5>ĐƠN ĐƯỢC DUYỆT</h5>
                </div>
                <div class="ibox-content">
                    <h1 class="no-margins">299</h1>
        ...
        <div class="col-lg-3">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <span class="label label-info pull-right">Tổng số đơn</span>
                    <h5>Orders</h5>
                </div>
                <div class="ibox-content">
                    <h1 class="no-margins">312</h1>
                    <div class="stat-percent font-bold text-danger">10% <i class="fa fa-level-down"></i></div>
                    <small>Số đơn bị hủy chiếm</small>
                </div>
            </div>
        </div>
        <div class="col-lg-3">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <h1 class="no-margins">109.069.000Đ</h1>
